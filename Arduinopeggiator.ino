...
#define P_UI_IN_LED      9
#define P_UI_SYNCH_LED   16
#define P_UI_OUT_LED     17
#define P_UI_HOLD_LED     8

#define P_UI_CLK     19
#define P_UI_DATA    18
#define P_UI_STROBE  15
#define P_UI_READ1   10
#define P_UI_READ0   6 

#define CBIT_UI_CLK     0b00100000  // C5
#define CBIT_UI_DATA    0b00010000  // C4
...
ISR(TIMER2_OVF_vect) 
{
  ...
  else
  {
    ...
    byte buttonIndex = ButtonIndexLookup[uiScanPosition];
